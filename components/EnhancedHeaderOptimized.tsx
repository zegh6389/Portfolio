...
import { useScrollProgress, useIsScrolled, useActiveSection } from "@/hooks/useScrollProgress";
...
// Magnetic button component with memoization
const MagneticButton = React.memo(function MagneticButton({ 
  ...
  const springX = useSpring(x, ANIMATION_CONFIG.SPRING_CONFIG.default);
  const springY = useSpring(y, ANIMATION_CONFIG.SPRING_CONFIG.default);
...
export default function EnhancedHeaderOptimized() {
  ...
  const activeSectionWithHash = `#${activeSection}`;
  ...
  return (
    <>
      ...
      <motion.header
        initial={{ y: -100 }}
        animate={{ y: 0 }}
        transition={{ type: "spring", ...ANIMATION_CONFIG.SPRING_CONFIG.smooth }}
        className={cn(
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <motion.div
                ...
                transition={{ delay: 0.5, type: "spring", ...ANIMATION_CONFIG.SPRING_CONFIG.slow }}
            ...
            <div className="hidden md:flex items-center">
              ...
              <div className="relative flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 dark:bg-white/5 backdrop-blur-md border border-white/20 dark:border-white/10">
                {navItems.map((item, index) => {
                  ...
                  const isActive = activeSectionWithHash === item.href;
                      ...
                      >
                        ...
                        {isActive && (
                          <motion.div
                            ...
                            transition={{ type: "spring", ...ANIMATION_CONFIG.SPRING_CONFIG.bouncy }}
                          />
                        )}
