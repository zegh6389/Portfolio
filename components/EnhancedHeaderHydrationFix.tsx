...
export default function EnhancedHeaderHydrationFix() {
  ...
  if (!mounted) {
    return (
      <>
        ...
        <div className="fixed top-0 left-0 right-0 h-1 bg-gradient-to-r from-primary via-purple-600 to-pink-600 z-[60]" style={{ transform: "scaleX(0)" }} />
          ...
          <nav className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between">
              ...
              <div className="hidden md:flex items-center">
                  ...
                  {navItems.map((item) => {
                    ...
                    return (
                      <a
                        key={item.href}
                        href={item.href}
                        className="relative px-4 py-2 rounded-full transition-all duration-300 flex items-center gap-2 text-foreground/70"
                      >
                ...
                <div className="ml-4">
                  <div className="relative rounded-full bg-white/10 dark:bg-white/5 backdrop-blur-md border border-white/20 dark:border-white/10 w-10 h-10" />
                </div>
              </div>

              {/* Mobile menu button placeholder */}
              <div className="md:hidden flex items-center gap-2">
                <div className="rounded-full bg-white/10 backdrop-blur-md border border-white/20 w-10 h-10" />
                <div className="rounded-full bg-white/10 backdrop-blur-md border border-white/20 w-10 h-10" />
              </div>
            </div>
          </nav>
