...
export default function EnhancedHeaderSafe() {
  ...
  useEffect(() => {
    ...
    const cleanupExtensions = () => {
      const unwantedIds = ['speechify-global-notifications', 'grammarly-desktop-integration'];
    ...
    // Periodic cleanup for dynamically injected elements
    const cleanupInterval = setInterval(cleanupExtensions, 500);
    
    // Cleanup after a few seconds (most extensions inject early)
