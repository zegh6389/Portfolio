...
// Augment window for optional debug prop
declare global {
  interface Window { __activeSection?: string }
}
...
export default function EnhancedHeaderFixed() {
  ...
  // Removed unused tickingRef; debug property typed globally
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      if (process.env.NODE_ENV !== 'production') {
        window.__activeSection = current;
      }
    };
